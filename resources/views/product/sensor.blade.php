            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                    ...
                    <div class="section-detail">
                        <span>เซ็นเซอร์ (Sensor) คืออุปกรณ์สำคัญที่ช่วยตรวจจับและวัดค่าต่าง ๆ ภายในระบบโซลาร์เซลล์ ไม่ว่าจะเป็นแสงอาทิตย์ อุณหภูมิ หรือแรงดันไฟฟ้า ข้อมูลที่ได้จะถูกส่งเข้าสู่ระบบควบคุมเพื่อปรับสมดุลการทำงานให้มีประสิทธิภาพและปลอดภัยยิ่งขึ้น การใช้เซ็นเซอร์คุณภาพสูงช่วยให้ผู้ใช้งานมั่นใจได้ว่า ระบบโซลาร์เซลล์สามารถผลิตพลังงานได้อย่างเสถียร ประหยัด และตรวจสอบได้แบบเรียลไทม์</span>
                    </div>
                </div>
            </div>
        </div>
